...
const CartProduct = (props) => {
    ...
    return (
        <div className="flex flex-row justify-between mt-3" id={`card-${props.idProduct}`}>
            <div className="flex flex-row gap-3">
                <img src={getImageUrl("americano.jpeg")} alt="americano" className="w-20 h-20 rounded-md" />
        ...
        <>
            <div className={`bg-white w-10/12 fixed z-50  py-4 px-6 top-[10%] shadow-md rounded-md lg:left-[10rem] left-[10%] font-montserrat min-h-96  ${props.isModalCartOpen ? 'animate-modal-slide-down block translate-y-0' : `animate-modal-slide-up translate-y-[-30rem] ${isHidden ? 'hidden': ''}`}`}>
                ...
                <div className="min-h-60">
                    ...
                    <div className="overflow-y-auto max-h-60" id="products">
               ...
               <div className="flex justify-end mt-3">
                    <button className="p-2 bg-primary rounded-md shadow-sm active:translate-y-[2px] transition duration-75">
                        Checkout Sekarang
                    </button>
               </div>
            </div>
